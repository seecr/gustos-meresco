...
class ResponseTimeTest(SeecrTestCase):
    ...
    def testReportAfterInterval(self):
        ...
        self.assertEqual(['report'] * 5, self.observer.calledMethodNames())
        sleep(0.1)
        self.top.do.handleQueryTimes(**msg(6))
        self.assertEqual(['report'] * 6, self.observer.calledMethodNames())
        ...
        self.assertEqual(['report'] * 10, self.observer.calledMethodNames())
        sleep(0.1)
        self.top.do.handleQueryTimes(**msg(11))
        self.assertEqual(['report'] * 11, self.observer.calledMethodNames())
